...
class _AddDebtSheetState extends State<AddDebtSheet> {
              ...
              itemBuilder: (_, i) {
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      Icon(categoryIconFor(p.cat), color: AppColors.accent, size: 22),
  ...
  void _save(BuildContext context) {
    ...
    if (name.isEmpty) {
      showToast(context, 'Enter a customer name', color: AppColors.warn);
      return;
    }
    if (_items.isEmpty) {
      showToast(context, 'Add at least one item', color: AppColors.warn);
      return;
    }
