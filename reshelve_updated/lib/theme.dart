...
// ── Category System (icons only, no emoji) ───────────────────────────────────
const kCategories = [
  'Fresh Produce',
  'Meat & Seafood',
  'Dairy & Eggs',
...
IconData categoryIconFor(String cat) =>
    kCategoryIconData[cat] ?? Icons.category_outlined;

// Keep categoryEmoji as fallback empty string — no longer used for display
