  ...
  Future<void> _printReceipt() async {
    ...
    pdf.addPage(pw.Page(
      ...
      build: (ctx) => pw.Column(
        ...
        children: [
          pw.Center(child: pw.Text('ReStore POS', style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold))),
        ...
        child: Column(children: [
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Center(
                child: Text('ReStore POS', style: TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.w700, fontFamily: 'monospace')),
              ),
              const Center(
              ...
              ...sale.items.map((item) => Padding(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Expanded(
                          child: Text('${item.emoji} ${item.name} x${item.qty}',
